...
import InteractiveParkMap from '../components/park/InteractiveParkMap'
  ...
  return (
    <div className="pb-24">
      <header className="px-4 pt-5 pb-4">
        <h1 className="text-[24px] font-semibold leading-tight">Türkenschanzpark</h1>
      ...
      <div className="px-4"><InteractiveParkMap /></div>
